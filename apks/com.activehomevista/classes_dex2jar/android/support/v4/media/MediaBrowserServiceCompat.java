  ...
  extends Service
{
  ...
  {
    Result local4 = new Result(paramString, paramResultReceiver)
    {
    ...
    this.mHandler.post(new Runnable()
    {
      public void run()
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localConnectionRecord.subscriptions.contains(paramString)) {
            MediaBrowserServiceCompat.this.performLoadChildren(paramString, localConnectionRecord);
          }
        }
      }
    });
    ...
    public void addSubscription(final String paramString, final IMediaBrowserServiceCompatCallbacks paramIMediaBrowserServiceCompatCallbacks)
    {
      MediaBrowserServiceCompat.this.mHandler.post(new Runnable()
      {
        public void run()
        {
          ...
          MediaBrowserServiceCompat.this.addSubscription(paramString, localConnectionRecord);
        }
      });
    }
    ...
    public void removeSubscription(final String paramString, final IMediaBrowserServiceCompatCallbacks paramIMediaBrowserServiceCompatCallbacks)
    {
      MediaBrowserServiceCompat.this.mHandler.post(new Runnable()
      {
        public void run()
        {
          ...
          while (localConnectionRecord.subscriptions.remove(paramString)) {
            return;
          }
