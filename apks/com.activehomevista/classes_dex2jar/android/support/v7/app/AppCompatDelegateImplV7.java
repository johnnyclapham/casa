  ...
  implements MenuBuilder.Callback, LayoutInflaterFactory
{
  ...
  private ViewGroup createSubDecor()
  {
    ...
    if (localTypedArray.getBoolean(R.styleable.Theme_windowNoTitle, false))
    {
  ...
  private boolean shouldInheritContext(ViewParent paramViewParent)
  {
    ...
    } while ((paramViewParent != this.mWindowDecor) && ((paramViewParent instanceof View)) && (!ViewCompat.isAttachedToWindow((View)paramViewParent)));
    return false;
  }
