  ...
  extends AppCompatTextHelper
{
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (localTypedArray.hasValue(0)) {
      this.mDrawableStartTint = createTintInfo(localContext, localTintManager, localTypedArray.getResourceId(0, 0));
    }
    if (localTypedArray.hasValue(1)) {
      this.mDrawableEndTint = createTintInfo(localContext, localTintManager, localTypedArray.getResourceId(1, 0));
    }
