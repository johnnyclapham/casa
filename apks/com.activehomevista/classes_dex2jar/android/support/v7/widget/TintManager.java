      ...
      if (localColorStateList == null)
      {
        ...
        while (localColorStateList != null)
        {
          ...
          if (paramInt == R.drawable.abc_switch_track_mtrl_alpha) {
            ...
            localColorStateList = createDefaultButtonColorStateList(localContext);
          } else if (paramInt == R.drawable.abc_btn_colored_material) {
            localColorStateList = createColoredButtonColorStateList(localContext);
            ...
            localColorStateList = createSeekbarThumbColorStateList(localContext);
          }
        }
      }
    }
