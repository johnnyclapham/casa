...
public class c
{
    ...
    throws JSONException
  {
    ...
    return new a(str2, str1, localArrayList, localList, localHashMap);
  }
    ...
    throws JSONException
  {
    ...
    if (localJSONObject2 != null) {
      if (localJSONObject2.has("refresh"))
      {
        ...
        {
          localInteger2 = Integer.valueOf(localJSONObject2.getInt("ad_network_timeout_millis"));
          localList1 = a(localJSONObject2, "imp_urls");
          localList2 = a(localJSONObject2, "click_urls");
        }
      }
    }
    for (List localList3 = a(localJSONObject2, "nofill_urls");; localList3 = null)
    {
